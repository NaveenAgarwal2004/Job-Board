...
const About = () => {
  const stats = [
    ...
    { label: 'Successful Hires', value: '12,500+', icon: Award },
    { label: 'Happy Users', value: '125,000+', icon: Heart }
  ];
  ...
  const values = [
    ...
    {
      title: 'Transparency',
      description: 'We believe in honest, clear communication between employers and job seekers.',
      icon: '🔍'
    },
    {
      title: 'Excellence',
    ...
    {
      title: 'Community',
      description: 'We foster a supportive community where everyone can achieve their career goals.',
      icon: '🤝'
    }
  ];
  ...
  const team = [
    ...
    },
    {
      ...
      bio: 'Tech veteran who has built scalable platforms for Fortune 500 companies.'
    },
    {
      name: 'Emily Rodriguez',
      role: 'Head of Product',
      image: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=400',
      bio: 'Product strategist passionate about creating user-centric experiences that drive results.'
    },
    {
      name: 'David Kim',
      role: 'Head of Marketing',
      image: 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=400',
      bio: 'Marketing expert focused on connecting the right talent with the right opportunities.'
    }
  ];

  const milestones = [
    { year: '2020', title: 'Company Founded', description: 'Started with a vision to revolutionize job searching' },
    { year: '2021', title: '10,000 Users', description: 'Reached our first major milestone of active users' },
    { year: '2022', title: 'Series A Funding', description: 'Secured $5M in funding to expand our platform' },
    { year: '2023', title: 'AI Integration', description: 'Launched AI-powered job matching technology' },
    { year: '2024', title: 'Global Expansion', description: 'Expanded to serve job seekers worldwide' }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                At JobBoard, we believe that finding the right job shouldn't be a struggle. 
                Our platform leverages cutting-edge technology and human insight to create 
                meaningful connections between job seekers and employers.
              </p>
              <p className="text-lg text-gray-700 mb-8">
                We're committed to democratizing access to opportunities and helping 
                everyone achieve their career aspirations, regardless of their background 
                or experience level.
              </p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From a small startup to a leading job platform, here's how we've grown.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              The passionate individuals behind JobBoard who work tirelessly to connect talent with opportunity.
            </p>
          </div>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Join thousands of professionals who have found their dream careers through JobBoard.
          </p>
